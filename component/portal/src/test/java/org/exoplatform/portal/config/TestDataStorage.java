...
//      assertEquals(page.getStorageId(), ch3.getDstId());
    ...
    *
    * For the moment, this JUnit test tests our dashboard migration
    * @throws Exception
    */
   public void testDashboard() throws Exception
   {
      ...
      assertEquals(1, page.getChildren().size());
      assertTrue(page.getChildren().get(0) instanceof Container);
      Container dashboardCont = (Container)page.getChildren().get(0);
      assertEquals("DashboardLayoutContainer", dashboardCont.getFactoryId());
      assertEquals("system:/groovy/portal/webui/container/UIDashboardLayoutContainer.gtmpl", dashboardCont.getTemplate());
   }
