...
public abstract class OAuthStoreContainer
{
   ...
   @Create
   protected abstract OAuthStoreMappingEntry createOAuthStoreMappingEntry();
   
   @OneToMany
   public abstract Map<String, OAuthStoreMappingEntry> getAllOAuthStoreMappingEntries();
}